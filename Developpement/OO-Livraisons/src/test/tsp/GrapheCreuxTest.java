...
public class GrapheCreuxTest {
    ...
    public void aretesTest() {
        ...
        graphe.ajouterArc(0, 1, 7);
        graphe.ajouterArc(1, 0, 7);
        graphe.ajouterArc(1, 2, 10);
        graphe.ajouterArc(2, 1, 10);
        graphe.ajouterArc(2, 0, 9);
        ...
        //Teste getCout.
        assertEquals("Le cout entre 0 et 1 doit etre de 7", 7, graphe.getCout(0, 1));
        assertEquals("Le cout entre 1 et 0 doit etre de 7", 7, graphe.getCout(1, 0));
        assertEquals("Le cout entre 1 et 2 doit etre de 10", 10, graphe.getCout(1, 2));
        assertEquals("Le cout entre 2 et 1 doit etre de 10", 10, graphe.getCout(2, 1));
        assertEquals("Le cout entre 2 et 0 doit etre de 9", 9, graphe.getCout(2, 0));
        assertEquals("Le cout entre 0 et 2 doit etre de -1", -1, graphe.getCout(0, 2));
    }
}
