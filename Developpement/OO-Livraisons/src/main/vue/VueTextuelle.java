...
public class VueTextuelle extends JPanel {
    ...
    private Collection<FenetreLivraisonVue> mesFenetresLivraisons;
    ...
    public void writeLivraisons(EnsembleLivraisons ensembleLivraisons, Tournee tournee) {
        ...
        DemandeLivraisonVue demandeLivraisonVue = new DemandeLivraisonVue(it_demandes.next(), CouleurCourante);
